...
const WatchlistMovie = () => {
  ...
  const url = `https://api.themoviedb.org/3/account/${REACT_APP_ACCOUNT_ID}/watchlist/movies?language=en-US&page=${page}`;
    ...
    <div className="container mt-5">
      <div className="row py-5">
        <div className="col-12 mt-2 mb-4 fs-1 fw-bold text-decoration-underline head d-flex justify-content-center align-items-center">
          ...
          <h4 className="text-white text-xl font-bold">Watchlist Movie</h4>
          <i className="fas fa-fire mx-4 text-danger"></i>
        </div>
        {
